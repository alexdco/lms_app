...
const formSchema = z.object({
    ...
    duration: z.coerce.number().min(1, {message: 'Companion name is required' }),
})
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>What topic do you need help with?</FormLabel>
                            <FormControl>
                                <Textarea placeholder="Ex. " {...field} className="input" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
